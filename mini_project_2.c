/******************************************************************************
    ...
    Connor Clark, Daniel Liebermen, Biya Miressa
    ELET-1102-001
    11/16/2020
    Mini Project 2

    This code calculates the total that a person spends on parts based on user 
    input for how many of that item they want and applies a discount based how 
    many they request
...
int main()
{
    ...
    printf("\nThe grand total of your purchase is $%.2f", grandTotal);
